...
function ScheduleArea({ slides, selectedSlide, liveSlide, onSelect }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto py-2", children: slides.map((slide) => {
...
function PreviewPanel({ selectedSlide, liveSlide }) {
      ...
      children: [
            ...
            children: [
              ...
              isLive && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block h-1.5 w-1.5 rounded-full bg-black animate-pulse" }),
                    "LIVE"
                  ]
                }
              )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: selectedSlide ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              selectedSlide.imagePath && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center p-3 text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold leading-tight", style: { color: "#fff" }, children: selectedSlide.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs leading-snug", style: { color: "rgba(255,255,255,0.7)" }, children: selectedSlide.body })
              ] })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "var(--color-text-muted)" }, children: "No slide selected" }) })
          }
        ) }),
        selectedSlide && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 px-4 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", style: { color: "var(--color-text-primary)" }, children: selectedSlide.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs leading-relaxed", style: { color: "var(--color-text-muted)" }, children: selectedSlide.body })
        ] })
      ]
    }
  );
...
var PureEditorContent = class extends React$2.Component {
  constructor(props) {
    var _a;
    super(props);
...
var EditorContent = React$2.memo(EditorContentWithKey);
...
var index_default$1 = StarterKit;
...
function SectionCard({
  ...
  const editor = useEditor({
    extensions: [
      index_default$1,
      index_default.configure({ types: ["paragraph"] }),
      FontFamily,
      TextStyle,
      FontSize
    ],
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2", children: [
          ...
          slideCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
